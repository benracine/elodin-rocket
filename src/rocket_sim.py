...
def create_world(pitch: float) -> el.World:
        ...
        [
            el.Body(
                ...
                inertia=el.SpatialInertia(
                    total_mass, jnp.array([0.1, 1.0, 1.0])
                ),  # Use total_mass variable
            ),
            Rocket(),
            w.glb(
                "https://storage.googleapis.com/elodin-assets/rocket.glb"
